      ...
      <View style={styles.search}>
        <Svg viewBox="0 0 24 24">
          <Path
            fill="#fff"
            fill-rule="nonzero"
            d="M10.04 0c5.545 0 10.04 4.495 10.04 10.04a10 10 0 0 1-2.333 6.435l5.99 5.992a.9.9 0 0 1-1.205 1.334l-.068-.061-5.992-5.99a10 10 0 0 1-6.432 2.33C4.495 20.08 0 15.585 0 10.04S4.495 0 10.04 0m0 1.8a8.241 8.241 0 0 0 0 16.48 8.241 8.241 0 0 0 0-16.48"
          />
        </Svg>
      </View>
    </View>
